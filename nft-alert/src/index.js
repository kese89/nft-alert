...
const config = {
  ...
  minOwnerDeltaEarly: Number(process.env.MIN_OWNER_DELTA_EARLY ?? 8),
  minVolume1dEthEarly: Number(process.env.MIN_VOLUME_1D_ETH_EARLY ?? 0.1),
  minVelocityWindowMin: Number(process.env.MIN_VELOCITY_WINDOW_MIN ?? 20),
  enableEarlySignal: process.env.ENABLE_EARLY_SIGNAL !== "false",
